	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				...
				<li><a href="${pageContext.request.contextPath}/amount/searchamountpage.action">查账</a></li>
	...
	<table class="table table-striped">
		<tr>
			<div id="firstins">
				...
				<div id="firstimg">
					<td><img alt="##"
						src="${pageContext.request.contextPath}/pictures/inst1.jpg">
					</td>
				</div>
		...
		<tr>
			<div id="secondins">
				...
				<div id="secondimg">
					<td><img alt="##"
						src="${pageContext.request.contextPath}/pictures/timg.jpg">
					</td>
				</div>
			</div>
		</tr>
		<tr>
			<div id="thirdins">
				<div id="thirdimg">
					<td><img alt="##"
						src="${pageContext.request.contextPath}/pictures/inst.jpg">
					</td>
				</div>
				<div id="thirdcontent">
					<td>
	...
	<div id="register" class="modal fade" tabindex="-1">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="${pageContext.request.contextPath}/user/register.action" method="post" class="form-group" >
